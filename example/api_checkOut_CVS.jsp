...
<%
	...
	try {
		...
		oPayment.Send.ReturnURL = ServerIP + "/checkOutFeedback_CSV.jsp";
		oPayment.Send.ClientBackURL = ServerIP + "/checkOutFeedback_CSV.jsp";
		oPayment.Send.OrderResultURL = ServerIP + "/checkOutFeedback_CSV.jsp";
		//		
